...
vim.keymap.set('n', '<Alt-Tab>', '<cmd>BufferLineCyclePrev<CR>', { desc = 'Go to prev buffer tab' })
vim.keymap.set('n', '<Tab>', '<cmd>BufferLineCycleNext<CR>', { desc = 'Go to next buffer tab' })
